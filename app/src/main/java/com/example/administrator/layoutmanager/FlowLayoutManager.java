...
public class FlowLayoutManager extends RecyclerView.LayoutManager {
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        private void readStyleParameters(Context context, AttributeSet attributeSet) {
            TypedArray a = context.obtainStyledAttributes(attributeSet, org.apmem.tools.layouts.R.styleable.FlowLayout_LayoutParams);
            try {
                this.newLine = a.getBoolean(org.apmem.tools.layouts.R.styleable.FlowLayout_LayoutParams_layout_newLine, false);
                this.gravity = a.getInt(org.apmem.tools.layouts.R.styleable.FlowLayout_LayoutParams_android_layout_gravity, Gravity.NO_GRAVITY);
                this.weight = a.getFloat(org.apmem.tools.layouts.R.styleable.FlowLayout_LayoutParams_layout_weight, -1.0f);
            } finally {
                a.recycle();
            }
        }
